...
import nz.ac.aut.ense701.gameModel.Serialization;
...
public class KiwiCountUI 
    ...
    implements GameEventListener, Serializable
{
    ...
    private void setAsGameListener() {
        System.out.println("EventListener Is Empty");
        System.out.println(game.eventListenerIsImpty());
        if (game.eventListenerIsImpty()) {
            game.addGameEventListener(this);
        }
        game.printSizeOfEventListener();
    }
    ...
    private void update()
    {
        ...
        //disable save button after player is not alive
    ...
    private void initComponents() {
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(10, 0, 0, 0);
        pnlPlayerData.add(scoreLabel, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        pnlPlayerData.add(scoreText, gridBagConstraints);
        ...
        pnlPlayer.add(btnSave, java.awt.BorderLayout.PAGE_END);
    ...
    /**
     * Creates and initialize the island grid.
     */
    final private void initIslandGrid()
    {
        // Add the grid
